...
let expName = 'full_dual-task';  // from the Builder filename that created this script
let expInfo = {
...
function tom_blockLoopBegin(tom_blockLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTom_block of tom_block) {
...
function tom_singleLoopBegin(tom_singleLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTom_single of tom_single) {
