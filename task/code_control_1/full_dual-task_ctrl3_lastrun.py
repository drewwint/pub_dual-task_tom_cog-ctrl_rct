...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\psychopy_full_dual-task_ctrl3\\full_dual-task_ctrl3_lastrun.py',
...
ssst_inst5 = visual.ImageStim(
    win=win,
    name='ssst_inst5', 
    image='practice_stimuli/inst_ssst_ctrl.png', mask=None, anchor='center',
...
dual_inst4 = visual.ImageStim(
    win=win,
    name='dual_inst4', 
    image='practice_stimuli/inst_dual-task_ctrl.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-3.0)
...
for thisPrac_ssst in prac_ssst:
    ...
    while continueRoutine:
        ...
        if prac_ssst_resp.status == STARTED and not waitOnFlip:
            theseKeys = prac_ssst_resp.getKeys(keyList=['space'], waitRelease=False)
        ...
        for thisSsst_loop1 in ssst_loop1:
            ...
            while continueRoutine:
                ...
                if ssst_resp.status == STARTED and not waitOnFlip:
                    theseKeys = ssst_resp.getKeys(keyList=['space'], waitRelease=False)
